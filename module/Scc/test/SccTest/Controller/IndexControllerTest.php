...
namespace SccTest\Controller;

use SccTest\Bootstrap;
...
class IndexControllerTest extends PHPUnit_Framework_TestCase {
	...
	$indexController = $cl->get('Scc\Controller\Index');
	...
	$pageMock = $this->getMockBuilder('Scc\Entity\Page')->disableOriginalConstructor()->getMock();
	$pageMock->expects($this->any())
		->method('getNodes')
		->will($this->returnValue(array()));
	$pageServiceMock = $this->getMock('Scc\Service\PageService');
